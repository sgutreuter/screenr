...
receiver-operating characteristics [3,4].

# Training Data {-}

A sample of `r dim(unicorns)[1]` properly consented unicorns were enrolled in a study
...
3. Linden A. Measuring diagnostic and predictive accuracy in disease
...
4. Fawcett T. An introduction to ROC analysis.  Pattern Recognition
   Letters. 2006; 27(8):861-874. DOI: 10.1016/j.patrec.2005.10.010.

5. Park MY, Hastie T. *L*1-regularization path algorithm for
