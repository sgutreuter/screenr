...
settings.  It may also be useful consider the model which yielded the
largest partial area under the ROC curve (pAUC)[6] if that differs
from the AIC- or BIC-best models. The default for pAUC is the area
...
plot(pathobj)
```
where the horizontal axis is the *L*1-norm of the coefficient vector and the vertical
axis shows values of the individual coefficients (see [3] for details).
