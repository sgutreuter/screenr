...
The `pROC` package provides a plot method for `roc`-class
objects. Note that the syntax of the arguments to `roc`-class objects
differs from usage in the `screenr` package:
