...
#' \item{\code{\link{geebinomScreening}}}{Test-screening based on logistic
#' regression implemented using generalized estimating equations (GEE) to
#' accommodate cluster sampling}
