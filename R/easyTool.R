...
#'
#' @param ... additional arguments passed to \code{coef.glmpathScreenr} or
#' \code{coef.logisticScreenr}
#'
#' @return
...
#'
#' @seealso
#' \code{`rescale_to_int`}, \code{`coef.easyTool`}, \code{ntpp.easyTool},
#' \code{`plot.easyTool`}, \code{`print.easyTool`} and \code{`summary.easyTool`}
#'
#' @examples
#' attach(uniobj1)
...
#' class(tool)
#' @export
easyTool <- function(object, max = 3, model = "minAIC",
                     crossval = TRUE, ...) {
